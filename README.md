...
- **Halaman Admin**: Sistem melakukan pengecekan otomatis pada umur, nilai IPK, sertifikat bahasa asing, dan UKBI yang menjadi persyaratan. Jika kandidat lolos verifikasi administrasi, maka panitia tahap administrasi akan melakukan verifikasi keabsahan dokumen yang diunggah kandidat.
- **Halaman Decision Maker (DM)**: 10 asesor per kriteria menilai berkas secara paralel sesuai dengan kriteria, yaitu esai, rencana studi, dan wawancara.
- **Halaman Kepala Puslapdik**: Kepala Puslapdik meninjau ranking final. Jika ada kandidat yang diganti, sistem akan melakukan auto-rerank dimana peserta di bawahnya otomatis naik mengisi kuota yang masih tersisa.
